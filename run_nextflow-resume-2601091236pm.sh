...
cd "${WORK_DIR}"
nextflow run main_full.nf -profile narval -resume --run_id analysis1 \
  --metadata /lustre06/project/6054517/lchang24/github/nf-genetic-correlations_260106/nf-genetic-correlations/data/metadata.txt \
  --lava_ref UKB